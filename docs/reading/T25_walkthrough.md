...
- Their two cases are the two ends of our one knob, λ. λ = 0 is "global term only" and λ = 1 is the full energy. That interpolation is ours; the paper treats them as two separate models.
