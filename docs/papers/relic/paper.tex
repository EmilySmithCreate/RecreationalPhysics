...
therefore kept by cooling in this model, which bears on the condition her dark-matter reading needs, that relics
last. What the model cannot say is how its sweep relates to a cosmological clock.
...
For the author's dark-matter reading, the first two are what the reading needs, and the last two bear on its
condition that relics last: in this model they last when their surroundings cool, on a clock the model cannot relate
to cosmic time. A small relic is not a problem, because matter thins out more slowly than radiation as space grows: at the
