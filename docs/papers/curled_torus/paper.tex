...
torus is reached. The mean waiting time follows Eq.~(\ref{eq:tau}) with nothing fitted over two decades, running
15 to 43\% longer than predicted near $\lambda = 1$ [Fig.~\ref{fig:lambda}(a)]. How completely the change finishes
...
Eq.~(\ref{eq:tau}) (nothing fitted) and the 200-sweep rest; shaded, the $\lambda$ at which it is not stuck.
