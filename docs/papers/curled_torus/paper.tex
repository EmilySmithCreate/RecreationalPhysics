...
\title{The curled torus burps: front-driven decompactification in a graph model of emergent geometry}
...
For $\lambda \ge 1$ the flat lattice torus is
...
$\lambda = 1$ and leaving more defects as $\lambda$ grows. The release vanishes at $\lambda = 1$, the CQG value. Every verdict quoted was pre-registered.
\end{abstract}
...
at $N = 100$ and falling with $N$ \cite{repo}. At this $\lambda$ the sharp change is between orders.
