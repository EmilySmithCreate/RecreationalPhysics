...
opens as a front and the second never does at any bath size from a quarter of $N$ to twice $N$; and a gas of fully
curled 6-cubes at $\lambda = 1.10$ joins and opens two of its three directions in 21 of 24 replicas, never into one
space. The author's rule that the space directions curl and open together predicted a cascade; the directions open one
at a time. The published six-link curve has not been reproduced, and every result here carries that caveat.
\end{abstract}
...
100,000 sweeps: with $C = 2N$, $N$, $N/2$ and $N/4$ at $N = 288$ and $C = 2N$ at 512, the first curled direction
opens as a front and the run ends on the one-curled rung, 95\% of vertices at $d = 2$, the energy 1.0 to 1.25 per
vertex against the rung's exact 1.0 (the excess is thermal defects), the bath near 0.4 to 0.5 per store; the second
direction never opens, its wall of 36 being unpayable at that bath. With $C = N/8$ the bath heats to 1 to 5 per
...
No cell has a flat majority: the verdict is FIRST ONLY.
...
vertices) and never one flat space; three replicas did not leave. This is further than the two-curled torus went,
