...
published curve reaches a factor of 2.8 sooner in coupling, and the plateau (10.07 against our 11.4), both in the
direction of graphs that carry triangles and pentagons, which the paper says its ground states do. The paper states
no protocol. The question has gone to the model's author; a six-link kernel allowing triangles and pentagons would
test it here. Until it is settled, everything above is a statement about our family and its kernel, validated on its
