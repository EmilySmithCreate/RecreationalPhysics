...
| Q5 | Start from an L×L torus melted at infinite temperature. | Ours. | Ours; melting is tested (`test_melts_at_infinite_temperature`). |
...
- **Independent check passed:** the hot-phase floor of φ matches the Poisson prediction (2D−1)⁴/4 = 20.25 squares regardless of N quoted in [T25]: predicted 0.2025, 0.1033, 0.0506, 0.0225; measured 0.198, 0.106, 0.053, 0.024 for N = 100, 196, 400, 900.
