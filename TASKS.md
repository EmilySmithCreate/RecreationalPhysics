...
VISION S5: a physicist reads it. Draft a short, honest note to C. Kelly, F. Biancalana or C. Trugenberger once Gates A and B have passed: what was reproduced, what was not, the code link, and a request for a sanity check. Also worth a line each: the 14-vertex baby universe (Q8) and the 30-vertex triangle-and-pentagon piece with H = 0 (Q10).
